  ...
  useEffect(() => {
    Object.entries(materials).forEach(([key, material]) => {
      if (
        ...
        const color = props.item.color?.[0] || "#FFFFFF";
  ...
  return (
    <group {...props} dispose={null}>
      ...
      <mesh
        castShadow
        receiveShadow
        geometry={nodes.rqgRAGHOwnuSJZC.geometry}
        material={materials.TgwBmFVHzoKfgsa}
        scale={0.01}
      />
      <mesh
        castShadow
        receiveShadow
        geometry={nodes.PnyEYcazGFLjCId.geometry}
        material={materials.ekefMEsRWpAwjzC}
        scale={0.01}
      />
    </group>
  );
